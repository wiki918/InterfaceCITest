...
localReadConfig = readConfig.ReadConfig()  #引入配置文件实例化作为对象
...
class ConfigHttp:
    ...
    def __init__(self):
        ...
        scheme = localReadConfig.get_http("scheme")  #http
        host = localReadConfig.get_http("baseurl")  #10.255.12.5
        port = localReadConfig.get_http("port") #8080
        timeout = localReadConfig.get_http("timeout")  #10.0
    ...
    def set_url(self, url):
        ...
        :return:
        """
        self.url = scheme+'://'+host+":"+port+url  #http://10.255.12.58080/zhuanle
        print(self.url)
    ...
    def set_files(self, filename):
        ...
        """
        if filename != '':
            file_path = 'D:/testpy/img/' + filename
